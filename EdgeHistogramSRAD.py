...
class EdgeEnhancementHistogramMatchingSRADFilter:
    ...
    def Execute(self, image):
        ...
        pyramid = tuple(pyramid_laplacian(sitk.GetArrayFromImage(exp_image), max_layer=3, downscale=2))
        ...
        edge = sitk.GetImageFromArray(pyramid_expand(edge, upscale=2 ** 3))
        ...
        while cur_iter < self.niter and err > self.errthre:
            ...
            err = np.mean((pre_arr - sitk.GetArrayFromImage(exp_image)) ** 2)
