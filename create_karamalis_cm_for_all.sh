...
for (( i=start_index; i<=end_index; i++ )); do
    ...
    if [ -f "${confidence_map_dir}/karamalis/${dataset_name}.npy" ]; then
    ...
    python create_karamalis_cm.py --input_path "$images_path" --participant_name "$dataset_name" --destination_dir "$confidence_map_dir"
