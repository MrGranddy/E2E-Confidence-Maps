...
params_dir="/home/vanessa_share/bugra/dataset_project/all_params"
...
for (( i=start_index; i<=end_index; i++ )); do
    ...
    python render_to_all_params.py --input_path "$params_path" --participant_name "$dataset_name" --destination_dir "$params_dir"
